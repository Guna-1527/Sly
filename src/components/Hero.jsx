    ...
    <div className="w-full h-[90vh] relative">
      <div className="w-[1100px] mt-[80px] m-auto flex justify-between items-center">
        <div className="LeftHero flex flex-1 flex-col">
          ...
          <p></p>
          <button className="flex border-solid outline-none border-2 px-3 py-2 rounded-md w-[100px] items-center justify-center mt-[30px] bg-black text-white">Explore</button>
        </div>
